...
const Plans = () => {
  ...
  return (
    <section id="plans" className="py-20 bg-gradient-section">
      <div className="max-w-7xl mx-auto px-6">
            ...
            >
              {plan.badge && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="flex items-center bg-gradient-primary text-white px-4 py-1 rounded-2xl text-sm font-semibold shadow-md">
                    {plan.popular ? (
                      <StarIcon
              ...
              <div className="p-6 pt-0 space-y-6 flex flex-col flex-grow">
                ...
                <button
                  type="button"
                  className={`w-full mt-auto px-6 py-3 rounded-lg font-semibold transition duration-200 ease-in-out ${
                    plan.popular
        ...
        <div className="mt-16 text-center">
          ...
          <button
            type="button"
            className="py-3 mx-auto border-primary border-2 hover:scale-105 hover:bg-primary hover:text-white shadow-xl rounded-xl px-10 font-semibold flex justify-center items-center gap-2 transition duration-200 ease-in-out text-primary"
            onClick={() => {}}
          >
